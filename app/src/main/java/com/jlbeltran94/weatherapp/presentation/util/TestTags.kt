...
object TestTags {
    ...
    const val DETAIL_CONDITION = "DETAIL_CONDITION"
    const val DETAIL_HIGH_LOW = "DETAIL_HIGH_LOW"
    const val WEATHER_DETAIL_SHIMMER = "WEATHER_DETAIL_SHIMMER"

    const val WEATHER_DETAIL_CONTENT = "WEATHER_DETAIL_CONTENT"
